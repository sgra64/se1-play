...
public class Numbers_1_sum_Tests {
    ...
    void test101_sum_regular() {
        assertEquals(50L, testObj.sum(testData.getArray("numb_1")));
    }

    @Test @Order(102)
    void test102_sum_regular() {
        assertEquals(10984L, testObj.sum(testData.getArray("numb_2")));
    }

    @Test @Order(103)
    void test103_sum_regular() {
        assertEquals(141466L, testObj.sum(testData.getArray("numb_3")));
    }
