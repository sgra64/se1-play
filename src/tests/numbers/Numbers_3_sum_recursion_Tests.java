 ...
 * Method under test: {@code long sumRecursive(int[] numbers, int i)}.
 */
...
public class Numbers_3_sum_recursion_Tests {
    ...
    void test300_sum_recursion_regular() {
        ...
        long actual = testObj.sumRecursive(testData_, 0);
        //
    ...
    void test301_sum_recursion_regular() {
        assertEquals(50L, testObj.sumRecursive(testData.getArray("numb_1"), 0));
    }

    @Test @Order(302)
    void test102_sum_recursion_regular() {
        assertEquals(10984L, testObj.sumRecursive(testData.getArray("numb_2"), 0));
    }

    @Test @Order(303)
    void test103_sum_recursion_regular() {
        assertEquals(141466L, testObj.sumRecursive(testData.getArray("numb_3"), 0));
    }
    ...
    void test300_sum_recursion_corner_empty_array() {
        ...
        assertEquals(0L, testObj.sumRecursive(testData, 0));
        ...
        testData[0] = 1;
        assertEquals(1L, testObj.sumRecursive(testData, 0));
    }
    ...
    void test310_sum_recursion_corner_big_array() {
        ...
        long expected = big;
        long actual = testObj.sumRecursive(testData, 0);
        assertEquals(expected, actual);
    }
